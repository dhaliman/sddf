...
_Static_assert(FB_IMG_WIDTH * FB_IMG_HEIGHT * GPU_BPP_2D <= GPU_DATA_REGION_SIZE_CLI0 - DISPLAY_INFO_DATA_OFFSET,
               "FB_IMG_WIDTH * FB_IMG_HEIGHT * GPU_BPP_2D must be less than or equal to GPU_VIRTIO_DATA_REGION_SIZE");
...
static void draw_image_blob(int resource_id, int res_width, int res_height, gpu_rect_t rect)
{
    ...
    DISPLAY_INFO_DATA_OFFSET, res_width * res_height * GPU_BPP_2D,
    rect.x, rect.y, rect.width, rect.height, 0, GPU_FORMAT_B8G8R8A8_UNORM,
    res_width, res_height, 0, res_width * GPU_BPP_2D,
...
static void draw_image(int resource_id, int res_width, int res_height, int xfer_offset, gpu_rect_t rect)
{
    ...
    rect.x, rect.y, rect.width, rect.height,
    rect.x, rect.y, rect.width, rect.height, xfer_offset,
    rect.x, rect.y, rect.width, rect.height);
}
...
static void do_draw_state(void)
{
    ...
    case DRAW_FULL:
         ...
         */
        draw_image(1, FB_IMG_WIDTH, FB_IMG_HEIGHT, 0, (gpu_rect_t){
            .x = 0,
            .y = 0,
            .width = FB_IMG_WIDTH,
    ...
    case DRAW_QUADRANT:
         ...
         */
        draw_image(2, FB_IMG_WIDTH, FB_IMG_HEIGHT, FB_IMG_WIDTH / 2 * GPU_BPP_2D, (gpu_rect_t){
            .x = FB_IMG_WIDTH / 2,
            .y = FB_IMG_HEIGHT / 2,
    ...
    case DRAW_FULL_BLOB:
         ...
         */
        draw_image_blob(1, FB_IMG_WIDTH, FB_IMG_HEIGHT, (gpu_rect_t){
            .x = 0,
            .y = 0,
            .width = FB_IMG_WIDTH,
            .height = FB_IMG_HEIGHT,
    ...
    case DRAW_QUADRANT_BLOB:
         ...
         */
        draw_image_blob(2, FB_IMG_WIDTH, FB_IMG_HEIGHT, (gpu_rect_t){
            .x = FB_IMG_WIDTH / 2,
            .y = FB_IMG_HEIGHT / 2,
            .width = FB_IMG_WIDTH / 2,
            .height = FB_IMG_HEIGHT / 2,
...
static void handle_display_info_response()
{
    ...
    for (int i = 0; i < display_info.num_scanouts; i++) {
        LOG_GPU_CLIENT("Scanout %d: enabled=%d, rect=(%d, %d, %d, %d) {x, y, width, height}\n", 
